...
(function (drawMode, undefined) {
    ...
    drawMode.onFrame = function (e) {
        ...
        var x0 = new THREE.Vector3(-500,0,0).add(sourceNode.position)
        var x1 = new THREE.Vector3(500,0,0).add(sourceNode.position)
        var xPt = new THREE.Vector3()
        var xd = raycaster.ray.distanceSqToSegment(x0,x1,null,xPt)
        
        var y0 = new THREE.Vector3(0,-500,0).add(sourceNode.position)
        var y1 = new THREE.Vector3(0,500,0).add(sourceNode.position)
        var yPt = new THREE.Vector3()
        var yd = raycaster.ray.distanceSqToSegment(y0,y1,null,yPt)
        
        var z0 = new THREE.Vector3(0,0,-500).add(sourceNode.position)
        var z1 = new THREE.Vector3(0,0,500).add(sourceNode.position)
